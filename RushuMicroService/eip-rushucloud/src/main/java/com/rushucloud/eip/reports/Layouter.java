...
public class Layouter
{
    ...
    private static Logger LOG = LogManager.getLogger(Layouter.class);
        ...
        FontFormatException, IOException
    {
        ...
        // your datasource
        drb.addColumn("Id", "id", Long.class.getName(), 100).addColumn("Amount", "amount", Double.class.getName(), 100)
        ...
        FontFormatException, IOException
    {
        ...
        try {
            ...
            parentReportBuilder.addConcatenatedReport(buildChildReportLayout(), new ClassicLayoutManager(),
                "dynamicReportDs", DJConstants.DATA_SOURCE_ORIGIN_PARAMETER, DJConstants.DATA_SOURCE_TYPE_COLLECTION);

        } catch (DJBuilderException e) {
            LOG.error("Unable to concat child report");
