...
public class Exporter
{
    ...
    /**
     * Exports a report to XLS (Excel) format. You can declare another export here, i.e PDF or CSV. You don't really
     * need to create a separate class or method for the exporter. You can call it directly within your Service or
     * Controller.
     * 
