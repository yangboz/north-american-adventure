...
INSERT INTO `items` (`id`, `created`, `date`, `updated`, `owner`, `amount`, `category`, `invoices`, `name`, `notes`, `participant_ids`, `type`, `vendors`) VALUES
(1, '2014-12-19 16:24:28', '2014-12-19 08:00:00', '2014-12-19 16:24:28', 'employee1', 99, '1', '1', '测试条目000', '说明。。。', NULL, 'CostComsumed', '1');